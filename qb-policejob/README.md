...
To set up these departments, simply customize the config.lua file and add them to the ( qb-core/shared/jobs ) folder as shown below. It's important to keep the 'type = "leo"' parameter the same if you want the department to have the same police functions.
...
NOTE - --(  In the config, most locations have been set up for my server, mainly Gabz MLO. So please change the config locations to suit your server.  )--
    ...
    ['lspd'] = {
        ...
        grades = {
            ...
            ['1'] = { name = 'Officer', payment = 250 },
            ['2'] = { name = 'Officer1', payment = 275 },
            ['3'] = { name = 'Officer2', payment = 300 },
            ['4'] = { name = 'Sergeant', payment = 350 },
            ['5'] = { name = 'Sergeant1', payment = 375 },
            ['6'] = { name = 'Lieutenant', payment = 400 },
            ['7'] = { name = 'Deputy Chief', payment = 450 },
            ['8'] = { name = 'lspd Chief', isboss = true, bankAuth = true, payment = 500 },
        },
    },
    --=============================================================================================================================================================================
    ['bcso'] = {
    ...
    ['noose'] = {
        ...
        grades = {
            ...
            ['6'] = { name = 'Lieutenant', payment = 400 },
            ['7'] = { name = 'Deputy Chief', payment = 450 },
            ['8'] = { name = 'noose Chief', isboss = true, bankAuth = true, payment = 500 },
        },
    },
    --=============================================================================================================================================================================
    ['fib'] = {
        ...
        grades = {
            ...
            ['6'] = { name = 'Lieutenant', payment = 400 },
            ['7'] = { name = 'Deputy Chief', payment = 450 },
            ['8'] = { name = 'fib Chief', isboss = true, bankAuth = true, payment = 500 },
        },
    },
    --=============================================================================================================================================================================
    ['army'] = {
        label = 'los santos national army',
            type = "leo",
        defaultDuty = true,
        offDutyPay = false,
        grades = {
            ...
            ['6'] = { name = 'Lieutenant', payment = 400 },
            ['7'] = { name = 'Deputy Chief', payment = 450 },
            ['8'] = { name = 'army Chief', isboss = true, bankAuth = true, payment = 500 },
        },
    },
    --=============================================================================================================================================================================
